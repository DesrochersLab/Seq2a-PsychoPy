...
init_book = xlrd.open_workbook(MATLABoutput_Params, ignore_workbook_corruption=True)

init01_sheet, init02_sheet = init_book.sheet_by_index(0), init_book.sheet_by_index(1)
init03_sheet, init04_sheet = init_book.sheet_by_index(2), init_book.sheet_by_index(3)
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Seq2a_PsPy\\Seq2a_2_lastrun.py',
